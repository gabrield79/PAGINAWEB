    ...
    <!-- The slideshow/carousel -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="imagenes/objetivo_general.png" alt="Los Angeles" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/objetivoespecifico1.png" alt="Chicago" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="imagenes/objetivoespecifico2.png" alt="New York" class="d-block w-100">
            </div>
              <div class="carousel-item">
                <img src="imagenes/objetivoespecifico3.png" alt="New York" class="d-block w-100">
            </div>
        </div>
